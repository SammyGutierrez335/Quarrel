  ...
  renderFollowIcon() {
    if (this.state.follow) {
      return <div id="follow-icon-pressed">
        <svg id="follow-icon" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <g>
            ...
            <polyline className="icon_svg-stroke" points="16 18.9953112 18 20.9953112 21.5 16.5"></polyline>
          </g>
        </svg>
      </div>
    } else {
      return <div id="follow-icon-unpressed">
        <svg id="follow-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
