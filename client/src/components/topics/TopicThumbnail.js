...
class TopicThumbnail extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        return (
            <div className="topic-thumbnail" >
                ...
                <div className="">
                    <div className="topic-thumbnail-header flex">
                        ...
                        <Link to={`/topic/${this.state.name}/questions`} key={this.props.topic._id} >
                            <div className="topic-thumbnail-name">
                                <h1>{this.state.name}</h1>
                            </div>
                        </Link>
                    </div>
                    <div className="topic-thumbnail-divider">
                        <div className="topic-thumbnail-footer">
